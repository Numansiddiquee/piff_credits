            ...
            <div class="card-body pt-9 pb-0">
                ...
                <ul class="nav nav-stretch nav-line-tabs nav-line-tabs-2x border-transparent fs-5 fw-bold">
                    <li class="nav-item mt-2">
                        <a class="nav-link text-active-primary ms-0 me-10 py-5 {{ Route::is('client.company.profile.view') ? 'active' : '' }}" href="{{ route('client.company.profile.view') }}">Overview</a>
                    </li>
                    <li class="nav-item mt-2">
                        <a class="nav-link text-active-primary ms-0 me-10 py-5 {{ Route::is('client.company.profile.setting') ? 'active' : '' }}" href="{{ route('client.company.profile.setting') }}">Settings</a>
                    </li>
                    <li class="nav-item mt-2">
                        <a class="nav-link text-active-primary ms-0 me-10 py-5 {{ Route::is('client.company.profile.security') ? 'active' : '' }}" href="{{ route('client.company.profile.security') }}">Security</a>
                    </li>
                    
                    <!-- <li class="nav-item mt-2">
                        <a class="nav-link text-active-primary ms-0 me-10 py-5 {{ Route::is('client.company.profile.payment.method') ? 'active' : '' }}" href="{{ route('client.company.profile.payment.method') }}">Payment Method</a>
                    </li> -->
                </ul>
            </div>
        </div>
        @if($action == 'view')
            @include('client.partials.setting.view')
        @elseif($action == 'setting')
            @include('client.partials.setting.edit')
        @elseif($action == 'security')
            @include('client.partials.setting.security')
        @elseif($action == 'general')
            @include('client.partials.setting.general')
        @else
            @include('client.partials.setting.payment_method')
        @endif
    </div>
@endsection
