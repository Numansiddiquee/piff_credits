<input type="text" class="d-none" value="{{ $current_quote->customer_id }}"
       id="customer_id">
...
{{--                <a href="#" class="text-gray-900 p-2 fs-7 text-hover-primary">--}}
{{--                    <i class="bi bi-paperclip"></i>--}}
{{--                    Attach Files</a>--}}
{{--                <a href="#" class="text-gray-900 p-2 fs-7 text-hover-primary" id="comments_logs_drawer_toggle">--}}
{{--                    <i class="bi bi-chat-left-dots"></i>--}}
{{--                    Comments and Logs--}}
{{--                </a>--}}
                <a href="{{ route('admin.quote.edit_quote',$current_quote->id)}}" class="btn btn-light btn-sm">Edit</a>
                ...
                <div
                    ...
                    <div class="menu-item px-5">
                        <a href="#" class="menu-link px-5 fs-6">Mark as inactive</a>
                    </div>
                    ...
                    <div class="menu-item px-5">
                        <a href="#" id="updateEditID"
                           class="menu-link px-5 text-uppercase fs-6">Void</a>
                    </div>
                </div>
            </div>
        </div>
    ...
    <div class="card-body m-2 p-0" id="quoteContent">
        <ul class="nav nav-custom nav-tabs nav-line-tabs nav-line-tabs-2x border-0 fs-4 fw-semibold mb-0 p-4 bg-light">
            ...
            <li class="nav-item activeLink">
                <a class="nav-link text-active-primary fs-6 mx-3 pb-2"><i class="bi bi-share fs-6 mr-1"></i> Share</a>
            </li>
            <li class="nav-item activeLink">
                ...
                <div
                    ...
                    data-kt-menu="true">
                    <div class="menu-item px-5">
                        <a href="{{ route('admin.quote.generatePDF', $current_quote->id) }}"
            ...
            <li class="nav-item activeLink">
                <a href="{{ route('admin.quote.convert_to_invoice',$current_quote->id) }}" class="text-gray-600 nav-link text-active-primary fs-6 mx-3 pb-2">
        ...
        <div class="tab-content" id="myTabContent">
                    ...
                    <div class="d-flex justify-content-between flex-column flex-sm-row mb-19">
                        <div class="text-sm-start">
                            ...
                            <div class="text-sm-start fw-semibold fs-4 mt-1">
                                ...
                                <span class="mt-1">{{ $user->company->country ?? ''}}</span><br>
                                <span class="mt-1">{{ $user->company->state ?? '' }}</span><br>
                        ...
                        <div class="d-flex flex-column gap-7 gap-md-10">
                            <div class="d-flex flex-sm-row align-items-center gap-7 gap-md-10 fw-bold">
                                <div class="flex-root d-flex flex-column gap-2">
                                    ...
                                    <a href="#"
                                       class="fs-5">{{ $current_quote->customer->display_name }}</a>
                                </div>
                                <div>
                                ...
                                <div class="table-responsive border-bottom mb-9">
                                    <table class="table align-middle table-row-dashed fs-6 gy-5 mb-0">
                                            ...
                                            <tr style="border-bottom: 1px solid;">
                                                ...
                                                <td>
                                                    <div class="ms-5">
                                                        ...
                                                        <div
                                                            class="fs-7 text-muted">{{ $item->item_description }}</div>
                                                    </div>
                                                </td>
                                                <td class="text-end">{{ $item->item_qty }}</td>
                                                <td class="text-end">{{ $item->item_rate }}</td>
                                                <td class="text-end"
                                                    style="padding-right: 1.5rem !important;">{{ $item->item_amount }}</td>
                                            </tr>
                                        @endforeach
                                        ...
                                        <tr>
                                            ...
                                            <td class="text-end" style="padding-right: 1.5rem !important;">
                                                $ {{ $current_quote->shipping_charges ?? 0 }}</td>
                                        </tr>
                                        <tr>
                            ...
                            <div class="mt-5">
                                ...
                                <p class="fs-7">{{ $current_quote->customer_notes }}</p>
                            </div>
                            <div class="mt-5">
            ...
            <div class="tab-pane fade" id="kt_reminder_email" role="tabpanel">
                @include('admin.partials.quotes.tabs.reminderEmail')
            </div>
        </div>
...
@include('admin.partials.quotes.attachment_drawer')
