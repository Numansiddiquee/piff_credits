...
<div id="kt_app_content" class="app-content flex-column-fluid">
    <div id="kt_app_content_container" class="app-container container-fluid">
        <form id="user-form" action="{{ route('admin.user.store') }}" method="POST" enctype="multipart/form-data" class="form d-flex flex-column flex-lg-row">
            @csrf
            ...
            <div class="d-flex flex-column flex-row-fluid gap-7 gap-lg-10">
                ...
                <div class="card card-flush py-4">
                    ...
                    <div class="card-body pt-0">
                        ...
                        <!-- Company Info -->
                        <div id="company-section" class="{{ old('role') == 'Client' ? '' : 'd-none' }} additionalSteps">
            ...
            <div class="d-flex flex-column gap-7 gap-lg-10 w-100 w-lg-300px mb-7 ms-lg-10">
                ...
                <!-- Company Logo -->
                <div class="card card-flush py-4 additionalSteps {{ old('role') == 'Client' ? '' : 'd-none' }}" id="company-logo-card">
                    <div class="card-header">
