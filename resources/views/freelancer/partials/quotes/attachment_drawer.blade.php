        ...
        <div class="card-header pe-5" id="attachment_drawer_messenger_header">
            ...
            <div class="card-title">
                ...
                <div class="d-flex justify-content-center flex-column me-3">
                    <div href="#" class="fs-4 fw-bold text-gray-900 text-hover-primary me-1 mb-2 lh-1">Quote Attachments</div>
                </div>
                <!--end::User-->
            </div>
            <!--end::Title-->
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <form id="attachment_upload_form" enctype="multipart/form-data">
                                    @csrf
                                    <input type="hidden" name="quote_id" value="{{ $current_quote->id }}">
