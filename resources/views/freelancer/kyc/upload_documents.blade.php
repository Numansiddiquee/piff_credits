        ...
        <div class="app-toolbar-wrapper d-flex flex-stack flex-wrap gap-4 w-100">
            <div class="app-toolbar-wrapper d-flex flex-stack flex-wrap gap-4 w-100">
	            <div class="page-title d-flex flex-column justify-content-center gap-1 me-3">
	                <h1 class="page-heading d-flex flex-column justify-content-center text-gray-900 fw-bold fs-3 m-0">KYC Verification</h1>
	            </div>
	            <div class="d-flex align-items-center gap-2 gap-lg-3">
	                <a href="{{ route('freelancer.kyc') }}" class="btn btn-flex btn-danger h-40px fs-7 fw-bold">Close</a>
	            </div>
	        </div>
        </div>
    </div>
...
<script>
    function getNewAccessToken() {
        return fetch("{{ route('freelancer.kyc.token') }}")
            .then(res => res.json())
