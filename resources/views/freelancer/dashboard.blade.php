		...
		<div class="col-sm-6 col-xl-2 mb-xl-10">
		    ...
		    <div class="card h-lg-100">
		        ...
		        <div class="card-body d-flex justify-content-between align-items-start flex-column">
		            <!--begin::Icon-->
		            <div class="m-0">
		                <i class="ki-outline ki-cheque fs-2hx text-gray-600"></i>
		            </div>
		            <!--end::Icon-->
		            <!--begin::Section-->
		            <div class="d-flex flex-column my-7">
		                ...
		                <!--begin::Title-->
		                <div class="m-0">
		                    <span class="fw-semibold fs-6 text-gray-500">Invoices</span>
		                </div>
		                <!--end::Title-->
		            </div>
		            <!--end::Section-->
		...
		<div class="col-sm-6 col-xl-2 mb-5 mb-xl-10">
		    ...
		    <div class="card h-lg-100">
		        ...
		        <div class="card-body d-flex justify-content-between align-items-start flex-column">
		            <!--begin::Icon-->
		            <div class="m-0">
		                <i class="ki-outline ki-notepad fs-2hx text-gray-600"></i>
		            </div>
		            <!--end::Icon-->
		            <!--begin::Section-->
		            <div class="d-flex flex-column my-7">
		                ...
		                <!--begin::Title-->
		                <div class="m-0">
		                    <span class="fw-semibold fs-6 text-gray-500">Quotes</span>
		                </div>
		                <!--end::Title-->
		            </div>
		            <!--end::Section-->
		    ...
		    <div class="card h-lg-100">
		        ...
		        <div class="card-body d-flex justify-content-between align-items-start flex-column">
		            ...
		            <div class="d-flex flex-column my-7">
		                ...
		                <!--begin::Title-->
		                <div class="m-0">
		                    <span class="fw-semibold fs-6 text-gray-500">Your Clients</span>
		                </div>
		                <!--end::Title-->
		            </div>
		            <!--end::Section-->
		...
		<div class="col-sm-6 col-xl-2 mb-xl-10">
		    ...
		    <div class="card h-lg-100">
		        ...
		        <div class="card-body d-flex justify-content-between align-items-start flex-column">
		            <!--begin::Icon-->
		            <div class="m-0">
		                <i class="ki-outline ki-wallet fs-2hx text-gray-600"></i>
		            </div>
		            <!--end::Icon-->
		            <!--begin::Section-->
		            <div class="d-flex flex-column my-7">
		                <!--begin::Number-->
		                <span class="fw-semibold fs-3x text-gray-800 lh-1 ls-n2">90K</span>
		                <!--end::Number-->
		                <!--begin::Title-->
		                <div class="m-0">
		                    <span class="fw-semibold fs-6 text-gray-500">Wallet Balance</span>
		                </div>
		                <!--end::Title-->
		            </div>
		            <!--end::Section-->
		...
		<div class="col-sm-6 col-xl-2 mb-xl-10">
		    ...
		    <div class="card h-lg-100">
		        ...
		        <div class="card-body d-flex justify-content-between align-items-start flex-column">
		            ...
		            <div class="d-flex flex-column my-7">
		                <!--begin::Number-->
		                <span class="fw-semibold fs-3x text-gray-800 lh-1 ls-n2">15k</span>
		                <!--end::Number-->
		                <!--begin::Title-->
		                <div class="m-0">
		                    <span class="fw-semibold fs-6 text-gray-500">Total Deposit</span>
		                </div>
		                <!--end::Title-->
		            </div>
		            <!--end::Section-->
			...
			<div class="card card-flush h-100 mb-5 mb-xl-10">
				...
				<div class="card-header pt-7">
					...
					<h3 class="card-title align-items-start flex-column">
						<span class="card-label fw-bold text-gray-900">Top Items</span>
						<span class="text-gray-500 pt-2 fw-semibold fs-6">Monthly Report</span>
					</h3>
				</div>
				<!--end::Header-->
				<!--begin::Body-->
		...
		<div class="col-xl-8 mb-xl-10">
			...
			<div class="card card-flush h-xl-50 mb-5 mb-xl-10">
				...
				<div class="card-header pt-7">
					<!--begin::Title-->
					<h3 class="card-title align-items-start flex-column">
						<span class="card-label fw-bold text-gray-800">Invoice Trends</span>
						<span class="text-gray-500 mt-1 fw-semibold fs-6">Monthly Report</span>
					</h3>
					<!--end::Title-->
				</div>
				<!--end::Header-->
			...
			<div class="card card-flush h-xl-50">
				...
				<div class="card-header py-5">
					<!--begin::Title-->
					<h3 class="card-title fw-bold text-gray-800">Quote Targets</h3>
					<!--end::Title-->
				</div>
				<!--end::Header-->
				<!--begin::Card body-->
	...
	<div class="row g-5 g-xl-10 mb-5 mb-xl-10">
		...
		<div class="col-xxl-4">
			<div class="card h-md-100" dir="ltr">
                <div class="card-header py-5">
                    <h3 class="card-title align-items-start flex-column">
                        <span class="card-label fw-bold text-gray-900">Transections</span>
                        <span class="text-gray-500 mt-1 fw-semibold fs-6">Latest Transections</span>
                    </h3>
                </div>
                <div class="card-body">
