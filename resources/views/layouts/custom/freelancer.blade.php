...
<head>
    ...
    <link href="{{ asset('assets/css/custom_global.css') }}" rel="stylesheet" type="text/css"/>
...
<div class="d-flex flex-column flex-root app-root" id="kt_app_root">
    ...
    <div class="app-page flex-column flex-column-fluid" id="kt_app_page">
        ...
        <div id="kt_app_header" class="app-header d-flex flex-column flex-stack">
            ...
            <div class="d-flex flex-stack flex-grow-1">
                <div class="app-header-logo d-flex align-items-center ps-lg-12" id="kt_app_header_logo">
                    ...
                    <!--begin::Logo-->
                    <a href="{{ route('freelancer.dashboard') }}" class="app-sidebar-logo">
                ...
                <div class="app-navbar flex-grow-1 justify-content-end" id="kt_app_header_navbar">
                    ...
                    <div class="app-navbar-item ms-2 ms-lg-6">
                        ...
                        @php
                            ...
                            // $logs = App\Models\LogsComment::where('user_id', $user->id)->where('type','log')->orderBy('created_at', 'desc')->get();
                            // $comments = App\Models\LogsComment::where('user_id', $user->id)->where('type','comment')->orderBy('created_at', 'desc')->get();
                        @endphp
                    ...
                    <div class="app-navbar-item ms-2 ms-lg-6" id="kt_header_user_menu_toggle">
                        ...
                        <div
                            ...
                            <div class="menu-item px-5">
                                <a href="{{ route('freelancer.profile.view') }}" class="menu-link px-5">My Profile</a>
                            </div>
                            <!--begin::Menu separator-->
                            <div class="separator my-2"></div>
                            <!--end::Menu separator-->
        ...
        <div class="app-wrapper flex-column flex-row-fluid" id="kt_app_wrapper" style="margin-right: 13px">
            @include('freelancer.partials.sidebar.left-sidebar')
            <!--begin::Main-->
