    ...
    <div id="kt_app_toolbar_container" class="app-container container-fluid d-flex align-items-stretch">
        <div class="app-toolbar-wrapper d-flex flex-stack flex-wrap gap-4 w-100">
            <div class="page-title d-flex flex-column justify-content-center gap-1 me-3">
                <h1 class="page-heading d-flex flex-column justify-content-center text-gray-900 fw-bold fs-3 m-0">Clients</h1>
            </div>
            <div class="d-flex align-items-center gap-2 gap-lg-3">
                <a href="#" class="btn btn-flex btn-primary h-40px fs-7 fw-bold">Add Client</a>
            </div>
        </div>
    </div>
</div>
        ...
        <div class="table-responsive">
            <table class="table table-hover table-rounded gy-4 gs-4 align-middle">
                ...
                <tr>
                    <td>
                        <div class="d-flex align-items-center">
                            <div class="symbol symbol-35px me-3"><img src="/media/avatars/300-1.jpg" alt=""></div>
                ...
                <tr>
                    <td>
                        <div class="d-flex align-items-center">
                            <div class="symbol symbol-35px me-3"><img src="/media/avatars/300-2.jpg" alt=""></div>
