                    ...
                    <div class="card-body">
                        <div class="row">
                            <div class="col-md-12">
                                ...
                                <div class="timeline timeline-border-dashed" id="quote_comments">
                                            ...
                                            @foreach($quote_comments_logs as $comment)
                                                <div class="timeline-item">
                                                    <div style="min-width: 100px; margin-top: 10px;text-align: right;">
                                                        <div class="date">{{date('Y-m-d'),strtotime($comment->created_at)}}</div>
                                                        <div class="time">{{date('H:i a',strtotime($comment->created_at))}}</div>
                                                    </div>
