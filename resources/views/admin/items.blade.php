        ...
        <div id="kt_app_toolbar_container" class="app-container container-fluid d-flex align-items-stretch">
            ...
            <div class="app-toolbar-wrapper d-flex flex-stack flex-wrap gap-4 w-100">
                ...
                <div class="d-flex align-items-center gap-2 gap-lg-3 d-none">
                    ...
                    <a href="{{ route('admin.item.create') }}" class="btn btn-flex btn-primary h-40px fs-7 fw-bold">Create
                        Item</a>
                </div>
                <!--end::Actions-->
            </div>
                    ...
                    <tbody>
	                    @if(count($items) > 0)
	                        @foreach($items as $item)
	                            <tr class="clickable_table_row" data-href="{{ route('admin.item.show',$item->id) }}">
	                                <td>
	                                    <div class="form-check form-check-sm form-check-custom form-check-solid">
	                                ...
	                                <td class="text-end">
	                                    <a href="{{ route('admin.item.edit',$item->id) }}" class="btn btn-icon btn-bg-light btn-active-color-primary btn-sm me-1">
