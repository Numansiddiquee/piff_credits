<div class="card pt-4 mb-6 mb-xl-9 rounded bordered shadow-sm mw-950px mt-5 m-auto">
    <div class="card-body py-20 " id="invoiceContent">
        <div class="mw-lg-950px mx-auto w-100">
            <div class="d-flex justify-content-between flex-column flex-sm-row mb-19">
                <div class="text-sm-start">
                    <div class="text-sm-start fw-semibold fs-4 mt-1">
                        <b class="">{{ $invoice->freelancer->name }}</b><br>
                        <span class="mt-1">{{ $invoice->freelancer->email }}</span><br>
                        <span class="mt-1">{{ $invoice->freelancer->phone }}</span><br>
                    </div>
                </div>
                ...
                <div class="d-flex flex-column gap-7 gap-md-10">
                    <div class="d-flex flex-sm-row align-items-center gap-7 gap-md-10 fw-bold">
                        <div class="flex-root d-flex flex-column">
                            ...
                            <a href="#" class="fs-5">{{ $invoice->freelancer->name ?? ''}}</a>
                        </div>
                        <div>
                        ...
                        <div class="table-responsive border-bottom mb-9">
                            <table class="table align-middle table-row-dashed fs-6 gy-5 mb-0">
                                ...
                                <tr>
                                    ...
                                    <td class="text-gray-900 fs-3 fw-bolder text-end">${{$invoice->total}}</td>
                                </tr>
                                </tbody>
                            </table>
                        </div>
...
@include('client.partials.invoice.comments_drawer')
